...
public class Res {
	...
	public String toString() {
		return "Res [resNum=" + resNum + ", siNum=" + siNum + ", mId=" + mId + ", resCateNum=" + resCateNum
				+ ", resName=" + resName + ", resLat=" + resLat + ", resLong=" + resLong + ", resAddr=" + resAddr
				+ ", resPrice=" + resPrice + ", resTel=" + resTel + ", resWeb=" + resWeb + ", resDetail=" + resDetail
				+ ", resStartTime=" + resStartTime + ", resCloseTime=" + resCloseTime + ", resRegTim=" + resRegTime
				+ "]";
	}
